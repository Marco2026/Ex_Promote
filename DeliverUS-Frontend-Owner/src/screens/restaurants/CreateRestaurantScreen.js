...
import { Image, Platform, Pressable, ScrollView, Switch, StyleSheet, View } from 'react-native'
...
export default function CreateRestaurantScreen ({ navigation }) {
  ...
  const initialRestaurantValues = { name: null, description: null, address: null, postalCode: null, url: null, promoted: false, shippingCosts: null, email: null, phone: null, restaurantCategoryId: null }
